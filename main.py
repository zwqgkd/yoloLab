...
if __name__=='__main__':
    # train("model_cfg/yolo11.yaml", "datasets/data.yaml", "yolo11n.pt") 
    # train("model_cfg/yolo11_concat_bifpn.yaml", "datasets/data.yaml", "yolo11n.pt") 
    train("model_cfg/yolo11_dcnv4.yaml", "datasets/data.yaml", "yolo11n.pt")
